...
LED_stimulus_spectral_intensity=readmatrix("LED_stimulus_spectral_intensity2.csv");
...
for i=1:391
    for j=1:26
        LED_stim_sum(i)=LED_stim_sum(i)+LED_stim_gamma(j)*LED_stimulus_spectral_intensity(j,i)/10;%390nm~780nmの分光分布を求める。
    end
end
