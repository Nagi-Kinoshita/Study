...
LED_input_data_complex=readmatrix("LED_input_data_complex.csv");
spectrum_output_data_complex=readmatrix("spectrum_output_data_complex.csv");
...
% データをCSVファイルに書き込み
writematrix(LED_input_data_complex, "LED_input_data_complex.csv");
writematrix(spectrum_output_data_complex, "spectrum_output_data_complex.csv");
